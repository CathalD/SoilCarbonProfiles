...
# Key columns expected in every input file:
#   profile_id, layer_id, profile_code, layer_name,
#   upper_depth, lower_depth, organic_surface, value_avg
# Adjust these names if your CSVs differ:
