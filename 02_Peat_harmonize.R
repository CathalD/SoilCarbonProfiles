...
# 0. USER SETTINGS
# -----------------------------------------------------------------------------
PATH_CORES    <- "data/peat_cores.csv"
PATH_PROFILES <- "data/peat_profiles.csv"
...
cores <- read_csv(PATH_CORES,    show_col_types = FALSE)
profs <- read_csv(PATH_PROFILES, show_col_types = FALSE)
